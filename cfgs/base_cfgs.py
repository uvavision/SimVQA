...
class Cfgs(PATH):
    def __init__(self):
        ...
        self.SPLIT = {
            ...
            'hypersim_count_val': 'hypersim_count_val',

            'hypersim_nyu40_count_val': 'hypersim_nyu40_count_val',

            'val_only_nyu40Labels': 'val_only_nyu40Labels',
        }
    ...
    def proc(self):
        # pcascante: also enable eval from hypersim val set
        ...
        # pcascante: force not to validate every epoch
        self.EVAL_EVERY_EPOCH = False
